...
# artist1.save
artist1 = Artist.new('name' => 'Calvin Harris', 'genre' => 'EDM')
# artist2.save

venue1 = Venue.new('capacity' => 50000, 'type'=>'indoor','location' => 'LA')
# venue1.save
venue2 = Venue.new('capacity' => 100000, 'type'=>'outdoor','location' => 'Strathallan')
#venue2.save
